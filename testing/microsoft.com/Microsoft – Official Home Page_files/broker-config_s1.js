...
COMSCORE.SiteRecruit.Broker.config = {
	...
	testMode: false,
	// START 5.1.3
	//cddsDomains: 'microsoftstore.com|windowsphone.com|xbox.com|adnxs.com',
	cddsDomains: 'microsoftstore.com|xbox.com|adnxs.com|(support|templates).office.com',
	...
	,{m: '//[\\w\\.-]+/cs-cz/(default\\.aspx)?$', c: 'inv_c_p162091074-CS-HP.js', f: 0.1536, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/da-dk/($|default\\.aspx$)', c: 'inv_c_p162091074-DENMARK_HP.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/de-at/(default\\.aspx)?$', c: 'inv_c_p162091074-DE-Austria-HP.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/de-ch/(default\\.aspx)?$', c: 'inv_c_p162091074-DE-Switz-HP.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/de-de/cloud/', c: 'inv_c_p73639549-Germany.js', f: 0.5, p: 0 	}
	,{m: '//(?!privacy)[\\w\\.-]*/de-de/(default\\.aspx|$)', c: 'inv_c_p162091074-Germany-HP.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/de-de/download', c: 'inv_c_p162095591-DLC-DE-DE.js', f: 0.0273, p: 1 	}
	,{m: '//[\\w\\.-]+/de-de/phone', c: 'inv_c_p291491624-DE-DE-Phone.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/de-de/windows/compatibility/CompatCenter/.*', c: 'inv_c_p176052898-DE-DE.js', f: 0.4262, p: 4 	}
	...
	,{m: '//[\\w\\.-]+/en-ca/download', c: 'inv_c_p162095591-DLC-EN-CA.js', f: 0.418, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/en-gb/(default\\.aspx|$)', c: 'inv_c_p162091074-EN-GB_HP.js', f: 0.5, p: 0 	}
	,{m: '//[\\w\\.-]+/en-gb/download', c: 'inv_c_p162095591-DLC-EN-GB.js', f: 0.1309, p: 1 	}
	...
	,{m: '//[\\w\\.-]+/en-gb/windows/compatibility/CompatCenter/.*', c: 'inv_c_p176052898-EN-GB.js', f: 0.5, p: 0 	}
	...
	,{m: '//(?!privacy)[\\w\\.-]+/en-in/($|default\\.aspx$)', c: 'inv_c_p162091074-EN-IN.js', f: 0.3355, p: 1 	}
	,{m: '//[\\w\\.-]+/en-in/download', c: 'inv_c_p162095591-DLC-EN-IN.js', f: 0.1295, p: 1 	}
	,{m: '//(www|wwwstaging)[\\w\\.-]*/en-us/(default\\.aspx)?$', c: 'inv_c_p38796305-EN-US-PREVIEW.js', f: 0.2968, p: 1 	}
	,{m: '//[\\w\\.-]+/(en-us/download)|(download/(en/|.*?displaylang=en))', c: 'inv_c_3331mt_p105571867-1345.js', f: 0.1586, p: 1 	}
	...
	,{m: '//[\\w\\.-]+/en-us/windows/compatibility/CompatCenter/.*', c: 'inv_c_p176052898-EN-US.js', f: 0.0311, p: 4 	}
	,{m: '//[\\w\\.-]+/en-us/windows/enterprise/', c: 'inv_c_p38361073-DDS.js', f: 0.5, p: 0 	}
	,{m: '//[\\w\\.-]+/en-za/($|default\\.aspx$)', c: 'inv_c_p162091074-EN-ZA_HP.js', f: 0.153, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/es-es/(default\\.aspx)?$', c: 'inv_c_p162091074-ES-ES.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/es-es/windows/compatibility/CompatCenter/.*', c: 'inv_c_p234872763-ES-ES.js', f: 0.3444, p: 4 	}
	,{m: '//(?!privacy)[\\w\\.-]+/es-mx/(default\\.aspx)?$', c: 'inv_c_p162091074-ES-MX-HP.js', f: 0.4864, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/fi-fi/(default\\.aspx)?$', c: 'inv_c_p55836780-FINLAND_HP.js', f: 0.5, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/fr-be/(default\\.aspx)?$', c: 'inv_c_p162091074-FR-BE-HP.js', f: 0.5, p: 1 	}
	...
	,{m: '//[\\w\\.-]+/fr-fr/download', c: 'inv_c_p162095591-DLC-FR-FR.js', f: 0.0299, p: 1 	}
	,{m: '//[\\w\\.-]+/fr-fr/phone', c: 'inv_c_p291491624-FR-FR-Phone.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/fr-fr/tablet', c: 'inv_c_p291491624-FR-FR-Tablet.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/fr-fr/windows/compatibility/CompatCenter/.*', c: 'inv_c_p176052898-FR-FR.js', f: 0.5, p: 4 	}
	,{m: '//[\\w\\.-]+/government/en-au/public-services', c: 'inv_c_p233386094-2329.js', f: 0.5, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/hu-hu/(default\\.aspx)?$', c: 'inv_c_p162091074-HU-HP.js', f: 0.1931, p: 0 	}
	...
	,{m: '//[\\w\\.-]+/ja-jp/atlife', c: 'inv_c_p15466742-JA-JP-ATLIFE.js', f: 0.0417, p: 1 	}
	,{m: '//(wwwstaging|www\\.microsoft\\.com)/ja-jp/(default\\.aspx)?$', c: 'inv_c_p15466742-Japan-HP.js', f: 0.1518, p: 1 	}
	,{m: '//[\\w\\.-]+/ja-jp/download', c: 'inv_c_p162095591-DLC-Japan.js', f: 0.0104, p: 1 	}
	,{m: '//[\\w\\.-]+/ja-jp/server-cloud', c: 'inv_c_JA-p15466742-server-cloud-WS.js', f: 0.091, p: 0 	}
	,{m: '//[\\w\\.-]+/ja-jp/tablet', c: 'inv_c_p291491624-JA-JP-Tablet.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/ja-jp/windows/compatibility/CompatCenter/.*', c: 'inv_c_p176052898-JA-JP.js', f: 0.5, p: 4 	}
	,{m: '//[\\w\\.-]+/japan/windows(/(?!(downloads/ie/au\\.mspx)|(downloads/ie/iedelete\\.mspx))|$)', c: 'inv_c_JA-p15466742-p37131508-windows.js', f: 0.0544, p: 1 	}
	,{m: '//(?!privacy)[\\w\\.-]+/ko-kr/(default\\.aspx)?$', c: 'inv_c_p162091074-KO-KR.js', f: 0.4255, p: 1 	}
]
};
	...
	if(_clickURL && _clickURL != '' && !(/javascript\:void(0)/i.test(_clickURL)) ){
		...
		if (r.test(_clickURL)) {
			if (/adnxs.com/i.test(_clickURL)) {
				...
				else if (/508385|502537|352314|432900|464219|508351|506103/.test(_clickURL)) { _clickURL = "www.microsoftstore.com"; }
				//else if (/26246/.test(_clickURL)) { _clickURL = "www.windowsphone.com"; }
				else if (/455599|455582|455602|424884|455532/.test(_clickURL)) { _clickURL = "www.visualstudio.com"; }
