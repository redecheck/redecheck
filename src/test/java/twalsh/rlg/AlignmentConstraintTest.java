...
public class AlignmentConstraintTest {
    ...
    public void testToStringSibling() throws Exception {
        String expected = "first , second , SIBLING , 400 , 1000 , belowleftAlignrightAlign";
...
//    new boolean[] {true, false, false, false, false, false, true, true}
    ...
    public void testGetAttributesSibling() throws Exception {
        assertTrue(Arrays.equals(acSib.getAttributes(), new boolean[]{true, false, false, false, false, false, true, true}));
    }

    @Test
    public void testSetAttributesSibling() throws Exception {
        acSib.setAttributes(new boolean[] {false, false, true, false, true, false, false, false});
        assertTrue(Arrays.equals(acSib.getAttributes(), new boolean[] {false, false, true, false, true, false, false, false}));
    }

    @Test
    public void testGenerateKeyWithoutLabelsContains() throws Exception {
        assertEquals(acPC.generateKeyWithoutLabels(), "secondfirstcontains");
    }

    @Test
    public void testGenerateKeyWithoutLabelsSibling() throws Exception {
        assertEquals(acSib.generateKeyWithoutLabels(), "firstsecondsibling");
    }
    ...
    public void testGenerateLabellingSibling() {
        assertEquals(acSib.generateLabelling(), "belowleftAlignrightAlign");
    }
