...
//		if (child.domNode.getxPath().equals("/HTML/BODY/DIV/FOOTER/DIV[2]/DIV/DIV/NAV/DIV/UL/LI/A")) {
//			System.out.println(child.x1 + "," + child.y1 + "," + child.x2 + "," + child.y2);
//			System.out.println(parent);
//////			System.out.println(px + " , " + cx);
//		}
//
//		if (child.domNode.getxPath().equals("/HTML/BODY/SECTION/DIV")) {
//			System.out.println("/HTML/BODY/SECTION/DIV     " + child.x1 + "," + child.y1 + "," + child.x2 + "," + child.y2);
////			System.out.println(px + " , " + cx);
//		}
