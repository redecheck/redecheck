...
//	private boolean sameChildren(List<DomNode> children2) {
...
//				for (DomNode c2 : children2) {
////					System.out.println(c2.getxPath());
//					if (c.equals(c2)) {
//						matched = true;
//					}
//				}
	...
	public String getLabel() {
		...
		if (attributes.size() > 0) {
			if (attributes.get("id") != null) {
				result += " " + attributes.get("id");
			} else if (attributes.get("class") != null) {
				result += " " + attributes.get("class");
			}
		}
		return result;
	}
